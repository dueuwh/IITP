...
_C.TRAIN.DATA.EMOTIONS = ['anger', 'anxiety', 'embarrassment', 'happy', 'hurt', 'neutral', 'sadness']
...
_C.VALID.DATA.EMOTIONS = ['anger', 'anxiety', 'embarrassment', 'happy', 'hurt', 'neutral', 'sadness']
...
_C.TEST.DATA.EMOTIONS = ['anger', 'anxiety', 'embarrassment', 'happy', 'hurt', 'neutral', 'sadness']
