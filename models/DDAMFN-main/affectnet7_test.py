...
def parse_args():
    ...
    parser.add_argument('--aff_path', type=str, default='D:/home/BCML/IITP/data/dataset_rearrange4DDAMFN/', help='AffectNet dataset path.')
    parser.add_argument('--batch_size', type=int, default=128, help='Batch size.')
    parser.add_argument('--workers', default=8, type=int, help='Number of data loading workers.')
    parser.add_argument('--num_head', type=int, default=2, help='Number of attention head.')
    parser.add_argument('--num_class', type=int, default=7, help='Number of class.')
    parser.add_argument('--model_path', default = './pretrained/MFN_msceleb.pth')
    parser.add_argument('--save_path', default = 'D:/home/BCML/IITP/data/results/', help='figure save path')
...
def run_test(folder_path):
    ...
    if args.num_class == 7: 
        ...
        plt.savefig(os.path.join(args.save_path+args.aff_path.split('/')[-1], "affecnet7"+"_acc"+str(acc)+".png"))
        plt.close()				
        ...
        plt.savefig(os.path.join(args.save_path+args.aff_path.split('/')[-1], "affecnet8"+"_acc"+str(acc)+".png"))
        plt.close()	

        
if __name__ == "__main__":
    frame_dir = "D:/home/BCML/IITP/data/dataset_rearrange4DDAMFN/"
    frame_folder_list = os.listdir(frame_dir)
    
    for name in frame_folder_list:
        print(f"{name}start")
        run_test(frame_dir+name)